...
- **Sub-fase 12.10 follow-up (når operatør gjenåpner):** YAML-wirings av ~50 nye drivere basert på live-demo-resultat; data-arkitektur-valg for *_surprise (cross-source FRED+FF eller alt feed); NASS yield/grain_stocks-utvidelse; ALSI/IIP-route-implementasjoner; resterende driver-impl-rewrites #36-#41.
