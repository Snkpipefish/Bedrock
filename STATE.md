...
- **Sub-fase 12.5 ÅPEN 2026-04-25** — debt-rydding før observasjonsvinduet kan gi mening. Roadmap: Block A drivere (~3-4 sessioner), Block B agri-drivere (~4-5), Block C instrumenter (~3-5), Block D polish (~2-3). Totalt 12-17 sessioner.
  ...
  - **100 (neste):** `analog`-driver SELL-asymmetri-fix per ADR-006 spesialtilfeller — threshold må flippes til negativ forward-return for SELL-direction. Eller asymmetrisk publish-floor for SP500/Nasdaq, branch-protection-oppsett.
