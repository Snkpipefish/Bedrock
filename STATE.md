...
- **Sub-fase 12.10 follow-up — gjenstår:** Bunke3 macro-utvidelser (t10y3m/hy_oas_change/anfci_z/m2_yoy/fomc_decision_distance/initial_claims_z/continuing_claims_z/industrial_production_yoy/cfnai_3mma/umich_sentiment_z/jolts_openings_yoy etc.), bunke4 move_index_z, bunke6 EIA-resterende (propane/refinery_utilization/petroleum_supplied/imports_crude/gasoline_demand), bunke7 AGSI-resterende (italy_pct/withdrawal_rate/injection_rate/cot_oi_change/cot_commercial_extreme), #34 multi-lookback-konsolidering, evt. cleanup av død enso_regime-driver. *_surprise (#5), NASS yield/grain_stocks (#20), ALSI/IIP (#24/#25), driver-impl-rewrites (#36-#41) — egne spor B/C/D/E.
