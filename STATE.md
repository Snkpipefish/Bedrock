...
- **Sub-fase 12.10 follow-up — gjenstår:** Bunke3 macro-utvidelser (t10y3m/hy_oas_change/anfci_z/m2_yoy/dollar_index_breadth/fomc_decision_distance/initial_claims_z etc.), bunke4 move_index_z, bunke6 EIA propane/refinery/imports/gasoline-demand, noaa_oni_index (#30 — agri-runde), AGSI per-land (bunke7), #34 multi-lookback. *_surprise (#5), NASS yield/grain_stocks (#20), ALSI/IIP (#24/#25), driver-impl-rewrites (#36-#41) — egne spor B/C/D/E.
