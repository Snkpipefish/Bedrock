...
- **Conab_estimates DB:** **118 rader 2022-2026** (session 118 manuell Excel-ingest av 41 boletim-filer for algodao/milho/soja/trigo, safra 2021/22-2025/26). **Data-gjeld:** Café/Coffee historikk mangler (separat boletim-serie); pre-2021/22 mangler. Refresh via user-systemd-timer 15. i mnd 20:00 Oslo.
...
3. **CONAB Café/Coffee boletim**: kun 7 rader fra 2026-04 (session 111 fikk 3 cafe-tier rader). Påvirker `conab_yoy`-driver for Coffee (vekt 1.0 i conab-familie). **Fix:** manuell Café-boletim-import fra `conab.gov.br/info-agro/safras/cafe`.
...
7. **CONAB algodao/milho/soja/trigo pre-2021/22**: 118 rader fra 2022. CONAB Pentaho-dashboard har eldre data via reverse-engineering av CDA `doQuery`-API (estimat 2-3 timer kode).
