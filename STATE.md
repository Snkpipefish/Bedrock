...
- **Sub-fase 12.10 follow-up — gjenstår:** EIA-utvidelser (6 thin-wrappers), bunke3 macro-utvidelser (t10y3m/hy_oas_change/anfci_z/m2_yoy etc.), noaa_oni_index (#30), dollar_index_breadth, AGSI-utvidelser (bunke7), #34 multi-lookback-konsolidering. *_surprise data-arkitektur (#5), NASS yield/grain_stocks (#20), ALSI/IIP-routes (#24/#25), driver-impl-rewrites (#36-#41) — egne spor B/C/D/E.
