...
- **Sub-fase 12.10 follow-up Spor A6 LUKKET 2026-05-02** (tag `v0.12.10-followup-a6`). Bunke6 EIA refinery-utilization. CrudeOil + Brent macro: `eia_refinery_utilization_z@0.10` (bunke6 #22). dxy 0.20→0.15, eia_stock 0.30→0.25.
  - **Snapshot-diff:** 12 score-Δ (energy bare), 0 grade-flips, ingen Δ > 0.1.
  - **Akkumulert A1-A6: 29 wirings + 7 replacements, 0 grade-flips totalt.** Diff-rapporter dokumentert per spor.
- **Sub-fase 12.10 follow-up — gjenstår:** Bunke3 resterende (hy_oas_change/anfci_z/fomc_decision_distance/initial_claims_z/continuing_claims_z/industrial_production_yoy/cfnai_3mma/umich_sentiment_z/jolts_openings_yoy/t_bill_3mo_yield), bunke4 move_index_z, bunke6 EIA-resterende (propane/petroleum_supplied/imports_crude/gasoline_demand), bunke7 AGSI-resterende (italy_pct/withdrawal_rate/injection_rate/cot_oi_change/cot_commercial_extreme), #34 multi-lookback, evt. cleanup av død enso_regime-driver. *_surprise (#5), NASS yield/grain_stocks (#20), ALSI/IIP (#24/#25), driver-impl-rewrites (#36-#41) — egne spor B/C/D/E.
